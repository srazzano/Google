...
(function() {
  ...
  const openInterval = 20,
        ...
        divLinksTooltip = 'Links in current tab or new tab',
        ...
        wallpaperDiv = $c('div', {id: 'divWallpaper'}),
  ...
  function init() {
    ...
    btnLinks.textContent = GM_getValue('linksWhere') === '_self' ? linksCurrentText : linksNewText;
  ...
  function searchLinksWhere(e) {
    ...
    bool === '_self' ? btnLinks.textContent = linksCurrentText : btnLinks.textContent = linksNewText;
    searchPopupLinks();
  }
