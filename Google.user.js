...
(function() {
  ...
  const buttonCalendar = true,
        ...
        icon7 = 'data:image/png;base64,',
  ...
  function aDateTime(int) {
    if (!GM_getValue('defaultDateTimeView') || !buttonClock) return;
    let date = new Date(),
        dy = date.getDay(),
        mth = date.getMonth(),
        dt = date.getDate(),
  ...
  function toggleDateTime(e) {
    if (!e.button === 0 || !buttonClock) return;
    let bool;
  ...
  var button1 = $c('button', {id: 'gCalendar', className: 'gBtn', textContent: 'Calendar', title: url1, style: 'background-image: url('+ icon1 +')', onclick: function() {window.open(url1, '_blank')}}),
      ...
      button6 = $c('button', {id: 'gNews', className: 'gBtn', textContent: 'News', title: url6, style: 'background-image: url('+ icon6 +')', onclick: function() {window.open(url6, '_blank')}}),
      button7 = $c('button', {id: 'gPhotos', className: 'gBtn', textContent: 'Photos', title: url7, style: 'background-image: url('+ icon7 +')', onclick: function() {window.open(url7, '_blank')}}),
      button8 = $c('button', {id: 'gPlay', className: 'gBtn', textContent: 'Play Store', title: url8, style: 'background-image: url('+ icon8 +')', onclick: function() {window.open(url8, '_blank')}}),
      button9 = $c('button', {id: 'gTranslate', className: 'gBtn', textContent: 'Translate', title: url9, style: 'background-image: url('+ icon9 +')', onclick: function() {window.open(url9, '_blank')}}),
      button10 = $c('button', {id: 'gYouTube', className: 'gBtn', textContent: 'YouTube', title: url10, style: 'background-image: url('+ icon10 +')', onclick: function() {window.open(url10, '_blank')}}),
      button11 = $c('button', {id: 'gYouTubeTV', className: 'gBtn', textContent: 'YouTube TV', title: url11, style: 'background-image: url('+ icon11 +')', onclick: function() {window.open(url11, '_blank')}}),
  ...
  if (buttonCalendar) div2.appendChild(button1);
  if (buttonEarth) div2.appendChild(button3);
  if (buttonMail) div2.appendChild(button4);
  if (buttonMaps) div2.appendChild(button5);
  if (buttonNews) div2.appendChild(button6);
  if (buttonPhotos) div2.appendChild(button7);
  if (buttonPlay) div2.appendChild(button8);
  if (buttonTranslate) div2.appendChild(button9);
  if (buttonYouTube) div2.appendChild(button10);
  if (buttonYouTubeTV) div2.appendChild(button11);
