...
(function() {
  ...
  const timerLong = 15000,
        ...
        url6 = 'https://news.google.com/topstories?hl',
        url7 = 'https://photos.google.com/?pageId=none',
        url8 = 'https://play.google.com/store/apps',
        url9 = 'https://podcasts.google.com/',
        url10 = 'https://translate.google.com/?hl=en',
        url11 = 'https://www.youtube.com/?gl=US',
        url12 = 'https://tv.youtube.com/library';
  ...
  var button1 = $c('button', {id: 'gCalendar', className: 'gBtn', textContent: 'Calendar', title: url1, style: 'background-image: url('+ icon1 +')', onclick: function() {window.open(url1, '_blank')}}),
      ...
      button9 = $c('button', {id: 'gPodcasts', className: 'gBtn', textContent: 'Podcasts', title: url9, style: 'background-image: url('+ icon9 +')', onclick: function() {window.open(url9, '_blank')}}),
      ...
      lf5 = $c('br'),
      checkbox6 = $c('input', {id: 'aNews', className: 'aCkbx', type: 'checkbox', checked: GM_getValue("aNews"), onclick: function(e) {onCheckbox(e)}}),
      ...
      lf6 = $c('br'),
      checkbox7 = $c('input', {id: 'aPhotos', className: 'aCkbx', type: 'checkbox', checked: GM_getValue("aPhotos"), onclick: function(e) {onCheckbox(e)}}),
      ...
      lf7 = $c('br'),
      checkbox8 = $c('input', {id: 'aPlay', className: 'aCkbx', type: 'checkbox', checked: GM_getValue("aPlay"), onclick: function(e) {onCheckbox(e)}}),
      ...
      lf8 = $c('br'),
      checkbox9 = $c('input', {id: 'aPodcasts', className: 'aCkbx', type: 'checkbox', checked: GM_getValue("aPodcasts"), onclick: function(e) {onCheckbox(e)}}),
      ...
      lf9 = $c('br'),
      checkbox10 = $c('input', {id: 'aTranslate', className: 'aCkbx', type: 'checkbox', checked: GM_getValue("aTranslate"), onclick: function(e) {onCheckbox(e)}}),
      ...
      lf10 = $c('br'),
      checkbox11 = $c('input', {id: 'aYouTube', className: 'aCkbx', type: 'checkbox', checked: GM_getValue("aYouTube"), onclick: function(e) {onCheckbox(e)}}),
      ...
      lf11 = $c('br'),
      checkbox12 = $c('input', {id: 'aYouTubeTV', className: 'aCkbx', type: 'checkbox', checked: GM_getValue("aYouTubeTV"), onclick: function(e) {onCheckbox(e)}}),
  ...
  if (GM_getValue('aNews')) div2.appendChild(button6);
  if (GM_getValue('aPhotos')) div2.appendChild(button7);
  if (GM_getValue('aPlay')) div2.appendChild(button8);
  if (GM_getValue('aPodcasts')) div2.appendChild(button9);
  if (GM_getValue('aTranslate')) div2.appendChild(button10);
  if (GM_getValue('aYouTube')) div2.appendChild(button11);
