...
(function() {
  ...
  const openInterval = 20,
        ...
        logoButton = 'data:image/png;base64,';
  ...
  var body = $q('body'),
      ...
      logoBtn = $c('span', {id: 'logoBtn', onclick: () => repositionLogo()}),
      img = $c('span', {id: 'googImg'}),
      imgBtn = $c('span', {id: 'imgBtn', onclick: () => repositionLogo()}),
