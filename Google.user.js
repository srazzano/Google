...
(function() {
  ...
  const openInterval = 20,
        ...
        arrowRight = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAALCAYAAABGbhwYAAAAOUlEQVR42mNkgIL/QMAIBAw4ACOyQrAADsUYCnEpxqoQm2KcCtEV41WIrJhyE4lyI1G+Jioc8cUMAIZtLAwYNSYbAAAAAElFTkSuQmCC',
        ...
        menuArrow = $c('img', {id: 'menuArrow', src: arrowRight});
  ...
  function init() {
    ...
    displayButtons.appendChild(menuArrow);
  ...
  GM_addStyle(''+
    ...
    '#gWP1 #lb > div > g-menu > g-menu-item:nth-child(7),'+
    '#gWP1 #lb > div > g-menu > g-menu-item:nth-child(8) {'+
    ...
    '  opacity: .6 !important;'+
    '}'+
    '#gWP1 #divButtons:hover #menuArrow {'+
    '  opacity: 1 !important;'+
    '}'+
    '#gWP1 #buttonWhen,'+
    '#gWP1 #buttonSites {'+
    ...
    '  padding: 0 !important;'+
    '}'+
    '#gWP1 .cF4V5c g-menu-item a,'+
    '#gWP1 .cF4V5c g-menu-item span {'+
    '  color: #CCC !important;'+
    ...
    '}'+
    '#gWP1 .cF4V5c g-menu-item a:hover,'+
    '#gWP1 .cF4V5c g-menu-item span:hover {'+
