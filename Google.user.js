...
(function() {
  ...
  const openInterval = 20,
        ...
        li3 = $c('li', {role: 'none'}),
        spnSites = $c('button', {id: 'spanSites', onclick: () => wallpaperSite()}),
        btnSites = $c('button', {id: 'buttonSites', onclick: () => wallpaperSite()}),
        li4 = $c('li', {role: 'none'}),
  ...
  function dateTimeFormat(int) {
    ...
    switch (int) {
      ...
      case 8: return customFormat + 176;
      case 9: return customFormat + 177;
  } }
